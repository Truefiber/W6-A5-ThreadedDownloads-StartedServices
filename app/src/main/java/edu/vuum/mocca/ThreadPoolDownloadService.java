...
public class ThreadPoolDownloadService extends Service {
    ...
    public static Intent makeIntent(Context context,
        ...
        return DownloadUtils.makeMessengerIntent(context, ThreadPoolDownloadService.class, handler,
                uri);
    }
	...
	public int onStartCommand(final Intent intent,
        ...
        Runnable downloadRunnable = new Runnable() {
            @Override
            public void run() {
                DownloadUtils.downloadAndRespond(ThreadPoolDownloadService.this, intent.getData(),
